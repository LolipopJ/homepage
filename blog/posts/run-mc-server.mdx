...
date: 2024-07-05
updated: 2024-07-13
banner: ./run-mc-server/banner.jpg
categories:
  - 技术琐事
tags:
  - Linux
...
笔者的服务器就可以通过域名 `mc.towind.cn` 连接，Minecraft 客户端将查询到域名背后的 IP 地址，访问其 25565 端口。
...
现在，我们不再需要放行 8123 端口，服务器地图通过 Nginx 监听的 443 端口转发，访问链接 https://mc.towind.cn/map 即可。
