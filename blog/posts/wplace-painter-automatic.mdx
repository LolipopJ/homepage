...
全流程用到了一些前端调试的知识，对非技术的小白用户并不友好，请见谅。如果对实现的细节不敢兴趣，可以直接跳到最后的[使用方法](#使用方法)部分，按照步骤操作即可。
...
- 生产环境脚本 [`BlueMarble.user.js`](https://github.com/LolipopJ/Wplace-BlueMarble/blob/main/dist/BlueMarble.user.js)，一般使用此版本即可。
