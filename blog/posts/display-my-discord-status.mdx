...
Discord 官方文档里好像有提到 API 请求限制是每分钟 120 次，笔者在这里设置为了每 5 秒请求 1 次，应该算 Bot 服务界的良心吧，请不要封禁我的账号！（后记：还是被封了，大抵是请求单一接口而且太有规律了吧）
...
启动应用，访问本地接口地址如 `localhost:28800/status`，就能看到指定 Discord 账号的状态信息了！
