...
话是这么说，但笔者并不是吃 AI 大模型这口饭的，没有意愿去一个个尝试哪个模型最好，这里就选择了社区推荐的 [Kimi 模型](https://platform.moonshot.cn/docs/overview)，据说它在任务规划上有着优异的表现，适合用作智能体的首脑。
...
人总是不想和死板生硬的机器人交流，为助理设置一个身份，能大大降低对话产生的机械感。OpenClaw 提供了 `~/.openclaw/<workspace>/IDENTITY.md` 文件，供用户配置助理的人设信息。没有太多要求，只要你喜欢！例如，笔者就让游戏《蔚蓝档案》里我最喜爱的天童爱丽丝变成了我的“值日学生”：
...
- **Vibe:** 是在废墟发现的来历不明的少女。包含年龄在内的所有情报都无从得知。现在和桃井、绿和柚子一起享受游戏，已经变成重度​游戏狂热者了。说话时有点生硬不自然，但那是因为她的语句几乎都是由怀旧游戏的台词所构成
- **Emoji:** ✨
